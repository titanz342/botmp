...
bot = telebot.TeleBot('7657870469:AAHymqRmXgnPZ6J7F9Gc6gSex9OUVEuRJkI')
...
def verificar_pagamento(operation_number, chat_id, message_id, client_name):
    for _ in range(24):  # Executa a verificação por 4 minutos (24 vezes a cada 10 segundos)
        ...
        if status == 'approved':
            ...
            bot.send_message(chat_id, f"Pagamento Confirmado ! {operation_number} Link Do Grupo t.me/+8gwungL8l69hOGFh\n\n"
...
def callback_handler(call):
    try:
        ...
        bot.send_message(call.message.chat.id, "Ocorreu um erro ao processar a solicitação. Tente novamente mais tarde.")
